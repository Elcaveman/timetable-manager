...
private IntClassDao classDao ;
    		...
    		throws SQLException, IOException
    {
    	...
    	System.out.println(request.getParameter("faculty_fk"));
    	System.out.println(request.getParameter("group"));
    	System.out.println(request.getParameter("free_time"));
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Class created successfully");
		...
		throws SQLException, IOException
    {
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Class updated successfully");
		response.sendRedirect("/Timetable_App/class/");
    }
    /**
	 * "/class/delete?id=1"
