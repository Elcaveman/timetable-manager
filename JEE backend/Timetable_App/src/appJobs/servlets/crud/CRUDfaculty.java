...
public class CRUDfaculty extends HttpServlet {
    		...
    		throws SQLException, IOException
    {
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Faculty created successfully");
		...
		throws SQLException, IOException
    {
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Faculty updated successfully");
		...
		throws SQLException, IOException
    {
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Faculty deleted successfully");
