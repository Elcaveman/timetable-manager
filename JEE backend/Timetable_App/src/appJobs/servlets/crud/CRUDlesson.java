...
private IntLessonDao lessonDao ;
    		...
    		throws ServletException, IOException 
    {
    	...
    	List<Faculty> listFaculty = facultyDao.selectFaculty(faculty);
    		...
    		throws SQLException, IOException
    {
    	...
    	System.out.println(request.getParameter("total_lessons"));
		...
		System.out.println(request.getParameter("lesson_link"));
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Lesson created successfully");
		...
		throws SQLException, IOException
    {
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Lesson updated successfully");
		response.sendRedirect("/Timetable_App/lesson/");
    }
    /**
	 * "/lesson/delete?id=1"
		...
		throws SQLException, IOException
    {
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Lesson deleted successfully");
		response.sendRedirect("/Timetable_App/lesson/");
    }
