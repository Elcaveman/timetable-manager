...
public class CRUDteacher extends HttpServlet {
    		...
    		throws SQLException, IOException
    {
		...
		teacher.setTeacherUserFk((long) 0);
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Teacher created successfully");
		...
		throws SQLException, IOException
    {
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Teacher updated successfully");
		response.sendRedirect("/Timetable_App/teacher/");
    }
    /**
	 * "/teacher/delete?id=1"
		...
		throws SQLException, IOException
    {
		...
		HttpSession session = request.getSession();
		session.setAttribute("success", "Teacher deleted successfully");
		response.sendRedirect("/Timetable_App/teacher/");
    }
