...
private IntTimetableDao timetableDao ;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
    	...
    	/* System.out.println(session.getAttribute("id"));
    	 ...
    	 System.out.println(!session.getAttribute("usertype").equals("admin"));*/
    		...
    		throws SQLException, IOException, ServletException
    {
    	...
    	timetable.setTimetableUserFk(user_id);
    		...
    		throws SQLException, IOException
    {
    	...
    	*/
		...
		session.setAttribute("success", "Timetable created successfully");
		...
		throws SQLException, IOException
    {
		...
		session.setAttribute("success", "Timetable updated successfully");
		response.sendRedirect("/Timetable_App/timetable/");
    }
    /**
		...
		throws SQLException, IOException
    {
		...
		session.setAttribute("success", "Timetable deleted successfully");
		response.sendRedirect("/Timetable_App/timetable/");
    }
