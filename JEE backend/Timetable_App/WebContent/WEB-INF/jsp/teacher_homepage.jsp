...
<head>
    ...
    <title>Timetable choice|Teacher</title>
</head>
...
<body>
  ...
  <div style="text-align:-webkit-center; margin-bottom:1rem;">
	 <h2>Timetable Choice - Teacher<c:out value="${timetable}"/></h2>
...
<script src="http://localhost:8000/static/js/teacher/Choices.js"></script>
