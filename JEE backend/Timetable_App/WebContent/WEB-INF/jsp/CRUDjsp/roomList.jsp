        ...
        <table border="1" class="responsive-table highlight">
            ...
            <c:forEach var="room" items="${listRoom}">
                <tr>
                    ...
                    <td style='color:white;background-color:<c:out value="${room.getRoomColor()}" />;'><c:out value="${room.getRoomColor()}" /></td>
                    
					
                    <td>
                       <a href="/Timetable_App/room/edit?id=<c:out value='${room.getRoomId()}' />">
                        <i class="material-icons">create</i>Edit
                        </a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/Timetable_App/room/delete?id=<c:out value='${room.getRoomId()}' />">
