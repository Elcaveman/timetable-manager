...
<body>
	...
	<div align="center">
    	<a href="/Timetable_App/timetable/new">
    	 <div class="btn wave-effect" style="background-color:#696969;">
     	   <i class="material-icons">add</i>Add New timetable
    	 </div>
     	</a>
        <table border="1" class="responsive-table highlight">
            ...
            <c:forEach var="timetable" items="${listTimetable}">
                <tr>
                    ...
                    <td><a class="btn wave-effect waves-light" href="/Timetable_App/timetables?tt_id=${timetable.getTimetableId()}">See Timetable</a></td>
                    <td>
                       <a href="/Timetable_App/timetable/edit?id=<c:out value='${timetable.getTimetableId()}' />">
                        <i class="material-icons">create</i>Edit
                        </a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/Timetable_App/timetable/delete?id=<c:out value='${timetable.getTimetableId()}' />">
