...
<body>
	...
	<div align="center">
    	<a href="/Timetable_App/faculty/new">
           ...
           <c:forEach var="faculty" items="${listFaculty}">
                <tr>
                    ...
                    <td><c:out value="${faculty.getFacultyYear()}" /></td>
					 ...
					 <td>
                       <a href="/Timetable_App/faculty/edit?id=<c:out value='${faculty.getFacultyId()}' />">
                        <i class="material-icons">create</i>Edit
                        </a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="/Timetable_App/faculty/delete?id=<c:out value='${faculty.getFacultyId()}' />">
