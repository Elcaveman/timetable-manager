...
public class Lesson {
	...
	public Lesson(Long teacher_fk, Long class_fk, Long room_fk, Long subject_fk, Long timetable_fk, Long total_lessons, String lesson_occ, String lesson_link, String color) {
	...
	public Lesson(Long id, Long teacher_fk, Long class_fk, Long room_fk, Long subject_fk, Long timetable_fk, Long total_lessons, String lesson_occ, String lesson_link, String color) {
		this.id = id;
		this.teacher_fk = teacher_fk;
		this.class_fk = class_fk;
		this.room_fk = room_fk;
	...
	public void setTotalLessons(Long total_lessons) {
		this.total_lessons = total_lessons;
	}
	...
	//getters and setters for details select variables
		...
		public Long setLessonTeacherFkReturn(Long teacher_fk) {
			return this.teacher_fk = teacher_fk;
		}
